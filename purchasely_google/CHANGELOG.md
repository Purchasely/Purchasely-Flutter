...
## 6.0.0
- Updated Android Purchasely Google Play SDK to `io.purchasely:google-play:6.0.1`.
...
- Keeps the Android Purchasely Google Play SDK pinned to `io.purchasely:google-play:6.0.0-rc.3`.

## 6.0.0-rc.2
- Updated Android Purchasely Google Play SDK to `io.purchasely:google-play:6.0.0-rc.3` (published on Maven Central).
...
## 5.7.2
- Updated Android Purchasely Google Play SDK to 5.7.3.
Full changelog available at https://docs.purchasely.com/changelog/57

## 5.7.1
- Updated Android Purchasely Google Play SDK to 5.7.1.
Full changelog available at https://docs.purchasely.com/changelog/57
