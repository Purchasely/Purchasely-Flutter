...
// own parameters. Use
// `PurchaselyV6Bridge.ensureInstalled().registerInterceptor(kind, handler)` to
// register per-action interceptors. The handler returns an `InterceptResult`
// (or a Future<InterceptResult>) to let the SDK know how the action was handled.
