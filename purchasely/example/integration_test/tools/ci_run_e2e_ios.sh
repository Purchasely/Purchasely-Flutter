...
echo "=== Suite 1/8: Dart↔iOS bridge (T1–T20) — HARD gate ==="
...
echo "=== Suite 4/8: interceptor trigger (idb tap) — best-effort ==="
...
echo "=== Suite 5/8: default dismiss handler via deeplink (idb tap close) — best-effort ==="
...
echo "=== Suite 6/8: default dismiss handler via fire-and-forget display() (idb tap close) — best-effort ==="
...
echo "=== Suite 7/8: local dismiss handler wins over default (idb tap close) — best-effort ==="
